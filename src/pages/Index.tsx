  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className="absolute top-6 left-0 right-0 z-30 flex justify-center">
        <div className="rounded-full border border-white/10 bg-white/5 backdrop-blur-xl px-5 py-2 shadow-lg shadow-black/20 flex items-center gap-2">
          <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-purple-600 text-white">
          ...
          <span className="font-medium text-white/85">EventBuddy</span>
            </div>
          </div>
      ...
      <div className="relative z-20 flex flex-col items-center text-center">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight text-white drop-shadow-[0_1px_12px_rgba(0,0,0,0.25)] max-w-4xl">
          AI Discord event bot
          <br className="hidden sm:block" />
          CSV import, channels, analytics
        </h1>

        <p className="text-white/70 text-lg md:text-xl max-w-2xl mx-auto mt-6 mb-8 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 max-w-4xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-white/60 text-sm">Upload attendee lists and auto-create event records with one command</p>
          </div>
            ...
            <h3 className="text-white font-semibold mb-2">Owner-Only Controls</h3>
            <p className="text-white/60 text-sm">Secure admin commands for server owners with confirmation prompts</p>
            </div>
            ...
            <h3 className="text-white font-semibold mb-2">Smart AI Responses</h3>
            <p className="text-white/60 text-sm">Answers event questions naturally, stays silent otherwise</p>
            </div>
          </div>
        </div>
    </div>
