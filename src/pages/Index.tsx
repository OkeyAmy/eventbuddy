      ...
      <div className="relative z-20 flex flex-col items-center text-center">
        ...
        <div className="mt-6 md:mt-8 flex justify-center px-4">
          <button
            ...
            className="px-6 md:px-8 py-3 md:py-4 rounded-full bg-white text-slate-900 font-semibold text-base md:text-lg shadow-lg hover:shadow-xl transition disabled:opacity-60 disabled:cursor-not-allowed flex items-center gap-2 md:gap-3 w-full sm:w-auto max-w-xs sm:max-w-none"
          >
            {isConnecting ? (
              <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mt-12 md:mt-16 max-w-6xl mx-auto px-4">
          <div className="text-center bg-white/5 rounded-2xl p-6 border border-white/10">
            ...
            <h3 className="text-white font-semibold mb-2 font-sans text-base md:text-lg">CSV Import</h3>
            <p className="text-white/70 text-sm md:text-base font-sans leading-relaxed">Upload attendee lists and auto-create event records with one command</p>
          </div>
          ...
          <div className="text-center bg-white/5 rounded-2xl p-6 border border-white/10">
            ...
            <h3 className="text-white font-semibold mb-2 font-sans text-base md:text-lg">Owner-Only Controls</h3>
            <p className="text-white/70 text-sm md:text-base font-sans leading-relaxed">Secure admin commands for server owners with confirmation prompts</p>
          </div>
          ...
          <div className="text-center bg-white/5 rounded-2xl p-6 border border-white/10">
            ...
            <h3 className="text-white font-semibold mb-2 font-sans text-base md:text-lg">Smart AI Responses</h3>
